...
function PublicAttachment() {
  ...
  {!annule && majApresEnvoi ? <div className="print:hidden rounded-md border border-primary/40 bg-primary/10 p-4"><strong>Document mis à jour le {new Date(a.updated_at).toLocaleString("fr-FR")}</strong><p className="text-sm text-muted-foreground">Vous consultez la version la plus récente : elle peut différer de l’e-mail que vous avez reçu.</p></div> : null}
