...
function PublicAttachment() {
  ...
  {!annule && majApresEnvoi ? <div className="print:hidden rounded-md border-2 border-orange-500/60 bg-orange-500/15 p-4"><strong className="text-orange-400">Document mis à jour le {new Date(a.updated_at).toLocaleString("fr-FR")}</strong><p className="text-sm text-muted-foreground">Vous consultez la version la plus récente : elle peut différer de l’e-mail que vous avez reçu.</p></div> : null}
