...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "IRVE Pro" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300..800&family=Space+Grotesk:wght@300..700&family=JetBrains+Mono:wght@400..700&family=Outfit:wght@600;700&family=Figtree:wght@400;500;600&display=swap",
      },
    ],
    scripts: [
      {
