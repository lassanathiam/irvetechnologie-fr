      ...
      <div className="mx-auto max-w-7xl space-y-6 px-6 py-10 text-mono text-premium-foreground/60">
        <div className="flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-6">
            <a href="mailto:contacts@irvetechnologie.fr" className="hover:text-premium-energy">contacts@irvetechnologie.fr</a>
            <a href="tel:+33633657840" className="hover:text-premium-energy">06 33 65 78 40</a>
            <Link to="/a-propos" className="hover:text-premium-energy">À propos</Link>
        ...
        <div className="grid gap-2 border-t border-premium-foreground/10 pt-6 text-xs leading-relaxed md:grid-cols-2">
          ...
          <div className="md:text-right">
            ...
            <div className="text-premium-energy">Qualifications IRVE P1 · P2 · P3</div>
          </div>
        </div>
      </div>
    </footer>
